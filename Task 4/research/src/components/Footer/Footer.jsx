const Footer = () => {
  return (
    // <footer className="w-full h-screen bg-blue-100 p-4 pb-1 relative">
    ...
    //     </div>
    //   </div>
    //   <p className="mt-4 absolute bottom-0 left-10">@2024 all right reserved</p>
    // </footer>
    <footer className="w-full h-screen bg-blue-100 p-4 pb-1 relative flex flex-col justify-between">
      <div className="w-full h-3/5 flex">
        <div className="w-full h-full text-left">
          <h2 className="text-3xl">Contact</h2>
          <div className="py-10">
